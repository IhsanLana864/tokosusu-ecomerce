    ...
    <div class="d-flex flex-wrap flex-lg-nowrap">
        ...
        <div class="coll-2 mb-sm-4 mb-3 mb-lg-0">
            ...
            <ul class="list-unstyled footerNavList">
                <li class="mb-1"><a href="javascript:void(0);">Produk Baru</a></li>
                <li class="mb-2"><a href="javascript:void(0);">Terlaris</a></li>
                <li class="mb-2"><a href="javascript:void(0);">Blog Kami</a></li>
                <li class="mb-2"><a href="javascript:void(0);">Tentang Toko Kami</a></li>
                <li><a href="javascript:void(0);">Kebijakan Privasi</a></li>
            </ul>
        </div>

        <div class="coll-3 mb-sm-4 mb-3 mb-lg-0">
            <h3 class="headingVI fwEbold text-uppercase mb-6">Akun Saya</h3>
            <ul class="list-unstyled footerNavList">
                <li class="mb-1"><a href="javascript:void(0);">Akun Saya</a></li>
                <li class="mb-2"><a href="javascript:void(0);">Diskon</a></li>
                <li class="mb-2"><a href="javascript:void(0);">Riwayat Pesanan</a></li>
                <li><a href="javascript:void(0);">Informasi Pribadi</a></li>
            </ul>
        </div>
